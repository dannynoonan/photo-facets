# Generated by Django 3.0.8 on 2020-07-15 06:40
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='Photo',
            fields=[
                ('uuid', models.CharField(db_index=True, max_length=36, primary_key=True, serialize=False)),
                ('source_file_name', models.CharField(db_index=True, max_length=64)),
                ...
                ('neighborhood', models.ForeignKey(db_column='neighborhood_slug', on_delete=django.db.models.deletion.CASCADE, to='lockdownsf.Neighborhood')),
            ],
        ),
    ]
