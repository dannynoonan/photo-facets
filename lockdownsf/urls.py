...
urlpatterns = [
    ...
    path(r'manage/photo_view/<str:photo_external_id>/', views.photo_view, name='photo_view'),
    path(r'manage/photo_edit/', views.photo_edit, name='photo_edit'),
    path(r'manage/photo_diff/<str:photo_external_id>/', views.photo_diff, name='photo_diff'),
